...
import '../../features/2beauty/data/repositories/login_repository.dart' as _i17;
import '../../features/2beauty/data/repositories/owner_repository.dart' as _i18;
...
import '../../features/2beauty/data/repositories/sign_up_repository.dart'
    as _i14;
import '../../features/2beauty/data/repositories/store_repository.dart' as _i28;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i13.ISignUpRepository>(() => _i14.SignUpRepository());
  gh.factory<_i15.IntroCubit>(() => _i15.IntroCubit(get<_i16.IntroState>()));
  gh.factory<_i17.LoginRepository>(() => _i17.LoginRepository());
  gh.factory<_i18.OwnerRepository>(() => _i18.OwnerRepository());
  gh.factory<_i19.PostAgendaDataUsecase>(() => _i19.PostAgendaDataUsecase());
  gh.factory<_i20.PostLoginUsecase>(() => _i20.PostLoginUsecase());
  gh.factory<_i21.PostNewOwnerUsecase>(() => _i21.PostNewOwnerUsecase());
  gh.factory<_i22.PostNewUserUsecase>(
      () => _i22.PostNewUserUsecase(get<_i13.ISignUpRepository>()));
  gh.factory<_i23.PostServiceDataUsecase>(() => _i23.PostServiceDataUsecase());
  gh.factory<_i24.PostStoreDataUsecase>(() => _i24.PostStoreDataUsecase());
  gh.factory<_i25.ProfileRepository>(() => _i25.ProfileRepository());
  gh.factory<_i26.ServiceRepository>(() => _i26.ServiceRepository());
  gh.factory<_i27.SignupCubit>(
      () => _i27.SignupCubit(get<_i22.PostNewUserUsecase>()));
  gh.factory<_i28.StoreRepository>(() => _i28.StoreRepository());
  gh.factory<_i29.LoginCubit>(
      () => _i29.LoginCubit(get<_i20.PostLoginUsecase>()));
  return get;
}
