...
import '../../features/2beauty/data/repositories/login_repository_imp.dart'
    as _i16;
import '../../features/2beauty/data/repositories/owner_repository.dart' as _i17;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i15.LoginRepository>(() => _i16.LoginRepositoryImp());
  gh.factory<_i17.OwnerRepository>(() => _i17.OwnerRepository());
  gh.factory<_i18.PostAgendaDataUsecase>(() => _i18.PostAgendaDataUsecase());
  gh.factory<_i19.PostLoginUsecase>(
      () => _i19.PostLoginUsecase(get<_i15.LoginRepository>()));
  gh.factory<_i20.PostNewOwnerUsecase>(() => _i20.PostNewOwnerUsecase());
  ...
  gh.factory<_i28.GetUserDataUsecase>(
      () => _i28.GetUserDataUsecase(get<_i11.IHomeRepository>()));
  gh.factory<_i29.HomeCubit>(
      () => _i29.HomeCubit(get<_i28.GetUserDataUsecase>()));
  gh.factory<_i30.LoginCubit>(
      () => _i30.LoginCubit(get<_i19.PostLoginUsecase>()));
  gh.factory<_i31.PostNewUserUsecase>(
      () => _i31.PostNewUserUsecase(get<_i25.SignUpRepository>()));
  gh.factory<_i32.SignupCubit>(
      () => _i32.SignupCubit(get<_i31.PostNewUserUsecase>()));
  return get;
}
